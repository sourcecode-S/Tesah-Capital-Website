...
export const metadata: Metadata = {
  title: "Privacy Policy | Tesah Capital",
  description: "Privacy Policy for Tesah Capital Limited",
}
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-white">Privacy Policy</h1>
              <p className="mx-auto max-w-[700px] text-white/80 md:text-xl">
                Tesah Capital Limited's privacy policy and terms of use.
              </p>
            </div>
          </div>
        </div>
